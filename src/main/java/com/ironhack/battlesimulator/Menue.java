...
public class Menue {
    public static void startMenue() {
        ...
        try {
             ...
             */
            final Window window = new BasicWindow("Warriors Battle");
             ...
             */
            Label title = new Label("Welcome on the battleground");
...
//                            .setLayoutData(GridLayout.createHorizontallyFilledLayoutData(1)));
            ...
            contentPanel.addComponent(new Label("Game"));
            contentPanel.addComponent(new Button("start", () ->             game2.startGame()));
